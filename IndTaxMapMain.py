#-------------------------------------------------------------------------------
# Name:         individual units Main: Tax Map MXD
# Purpose:      Creates tuple list of all units and then iterates through list to only
#               produce units specified in MxdList
...
string3 = "_Lbl"
# Path for new PDF
OutPath = "C:\\AC\\Projects\\2017TaxMaps\\buildTest\\ap8"

#MxdList = ["42","44","17","18","19","20","21","22","23","24","51","52","54","55","56","57","59"]

#MxdList = ["16","17"]
#List of units that ordered aerials 2016
#MxdList = ["07","09","12","13","16","17","18","20","22","59"]
#MxdList = ["13","16","17","18","20","22","52","59"]
MxdList = ["52"]
...
for tup in Tuple1:
    if tup[0] in MxdList:
        ...
        # Save Mxd to file
        #   Note: dynamic text in the ddp requires this line to remain"mxd.saveACopy(os.path.join(ws,unum +".mxd"))"
        #   for label to work properly
        mxd.saveACopy(os.path.join(ws,unum +".mxd"))

        # Export new mxd to PDF
        MxdFunctions.MxdExport(mxd,OutPath)
        #MxdFunctions.MxdExport(mxd, OutPath,"LAYERS_AND_ATTRIBUTES")
